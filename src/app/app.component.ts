...
export class AppComponent {
  ...
  filterData = [
    {
      lawName: 'Minimum Wages Act',
      year: '1948',
      lawTitle:'Minimum Wages Act, 1948-The Minimum Wages Act, 1948 (the Minimum Wages Act) provides for fixing of minimum rates of wages in certain employments',
    ...
    {
      lawName: 'Payment of Wages Act',
      year: '1936',
      lawTitle:'Payment of Wages Act, 1936-The Payment of Wages Act, 1936 (the Payment of Wages Act) is an Act to regulate the payment of wages to certain classes of employed persons',
    ...
    {
      lawName: 'Payment of Bonus Act',
      year:'1965',
      lawTitle:'Payment of Bonus Act, 1965-The Payment of Bonus Act, 1965 (the "Bonus Act") provides for the payment of bonus to persons employed in certain establishments in India either on the basis of profits or on the basis of production or productivity',
